...
const Navigation = ({ currentPage, onPageChange, user, onLogout, onOpenCtfAdmin, platformConfig = {} }) => {
      ...
      >
        ...
        <div className="flex items-center space-x-2">
          ...
          {user && (
            <>
              <motion.button
                className="nav-link flex items-center space-x-2 px-4 py-2 rounded-lg ml-4 bg-yellow-500/20 text-yellow-400 hover:bg-yellow-500/30"
                onClick={onOpenCtfAdmin}
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                title="CTF Admin Panel"
              >
                <Settings size={18} />
                <span>Admin</span>
              </motion.button>
      ...
      >
        ...
        >
          <div className="w-6 h-6 flex items-center justify-center">
            ...
            <div className="text-xl" style={{ display: platformConfig.platform_logo ? 'none' : 'block' }}>
              🌱
            </div>
          </div>
          <div>
            <h1 
              ...
              style={{ color: platformConfig.primary_color || '#00ff88' }}
            >
              {platformConfig.platform_name || 'Green Eco CTF'}
            </h1>
          </div>
        </motion.div>
